...
function typeSanaText(text, element, speed = 55, callback = null) {
    ...
    typeSanaText(
        ...
        function () {
            ...
            if (introStep === introMessages.length - 1) {
                ...
                introNext.textContent = "نبدأ التعارف ☀️";

            } else {

                introNext.textContent = "متابعة";
